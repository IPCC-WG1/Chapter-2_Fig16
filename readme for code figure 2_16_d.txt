...
# - Input data: MATLAB file of global ocean precipitation minus evaporation (P-E) from a variety of datasets. The file can be accessed at: *Link to CEDA catalogue*
